  ...
  return (
    ...
    <div id="pagetop" className="w3-bar notranslate w3-white">
      ...
      {user.tutor ? ( 
        ...
        <Link className="w3-button w3-block ga-top ga-top-menu-tut-and-ref" style={{ fontSize: '22px' }} to="/add-chapters">
        Subject Chapters<i className='fa fa-caret-down w3-right'></i>
        </Link>
        <Link className="w3-button w3-block ga-top ga-top-menu-tut-and-ref" style={{ fontSize: '22px' }} to="/add-questions">
        Chapter Questions<i className='fa fa-caret-down w3-right'></i>
        </Link>
        <Link className="w3-button w3-block ga-top ga-top-menu-tut-and-ref" style={{ fontSize: '22px' }} to="/students">
        Students<i className='fa fa-caret-down w3-right'></i>
        </Link>
        <Link className="w3-button w3-block ga-top ga-top-menu-tut-and-ref" style={{ fontSize: '22px' }} to="/tutors">
