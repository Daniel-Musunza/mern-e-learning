...
function Header() {
  ...
  return (
    ...
    {user ? (
       ...
       <div onClick={onLogout} id="loginactioncontainer" class="w3-right"
        ...
        <div id="loginactioncontainer" class="w3-right"
          ...
          <div id="mypagediv"></div>
          <div id="w3loginbtn" title="Login to your account"
            class="w3-bar-item w3-btn bar-item-hover w3-right ws-light-green ga-top ga-top-login"
            target="_self">
        ...
        <div id="loginactioncontainer" class="w3-right"
          ...
          <div id="w3loginbtn" title="Your Username" style={{paddingLeft:'3px'}}
            class="w3-bar-item w3-btn bar-item-hover w3-right ws-light-green ga-top ga-top-login"
            target="_self">{user && user.name}</div>
        </div>
        ) : (
          <div id="signupbtn_topnav" class="w3-bar-item w3-button w3-right ws-green ws-hover-green ga-top ga-top-signup"
   ...
   {showMenu && (
    ...
    <a href=""  onClick={closeMenu} className="w3-button w3-large w3-right ga-top w3-border w3-round ga-top-close-accordion" style={{ marginBottom: '13px', marginRight: '13px', marginTop: '13px', width: '100px' }}>
      Close
    ...
    <div className="w3-container">
      ...
      {/* <a onClick={toggleExams} className="w3-button w3-block ga-top ga-top-menu-cert-and-course" style={{ fontSize: '22px' }} href="javascript:void(0);">
        Main Exam <i className='fa fa-caret-down w3-right'></i>
      </a>
      {showExams && (<div id="sectionxs_certified" className="w3-show" style={{ backgroundColor: '#282A35', color: 'white' }}>
        <div className="w3-content" style={{ maxWidth: 1100, fontSize: 18, paddingLeft: '3%' }}>
          <span
              className="w3-button w3-xxxlarge w3-display-topright closeaccbtn w3-hide-small"
              onClick={closeExams}
