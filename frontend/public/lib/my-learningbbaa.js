...
MyLearning._version_and_name_to_rel_url_map = {
  '1': {
    ...
    'api.CAT.set_score': '/mypage/set_CAT_score2.php'
  },
  '1.5': {
    'api.meta': '/api/meta/',
    ...
    'api.CAT.set_score': '/api/CAT/set-score/'
  },
  '1.5L': {
    'api.meta': '/api/meta/',
    'api.meta_for_default': '/api/meta-for-default/',
  ...
  '2': {
    ...
    'api.CAT.set_score': '/api/classic/set-CAT-progress'
  },
  '2.1': {
    'api.meta': '/api/classic/get-set-topic-progress',
    'api.exercise.get': '/api/classic/get-Exercises-progress',
...
// usage:
// MyLearning.getUrl('api.CAT.set_score') -> https://mypage.w3schools.com/mypage/set_CAT_score2.php
...
// < footer
MyLearning._footerLoadUser = function () { // on lessons this is the first request, on CAT the only one
  ...
  if (urlPathWlo.indexOf('CATtest/CATtest') === 0) {
    isCATPage = true;
